...
export function processPic(pic) {
  if (!pic) return ''
...
export function handleProtoBuf(encryptedData) {
...
export function rgb888ToRgb(rgb888) {
...
export function processAvatarLink(avatar) {
  if (!avatar) return ''
...
export function changeUrlSearchParam(params) {
  // 获取当前 URL 的参数
